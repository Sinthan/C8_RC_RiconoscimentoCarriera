...
class StudentDAOTest extends Mockito {
  ...
  void testDoRetriveStudentOK() throws ServletException, IOException {
    Student s = sDAO.doRetrieveStudent("g.rossi31@studenti.unisa.it",
        "4bb47fd2a6c598d2a52ef7de3473fd3ea8401a9b");
  ...
  void testDoRetriveStudentFailEmail() throws ServletException, IOException {
    Student s = sDAO.doRetrieveStudent("r.deluca@stud3enti.unisa.it",
        "9611edf7f716b00c8a44441973906aa7f5c0c580");
    assertEquals(null, s);
  }
  ...
  void testInserteStudenteOK() throws ServletException, IOException {
    int result =
        sDAO.insertStudent("gerardo@gmail.it", "gerardo", "damiano", 0, 'M', "123456789", null);
    assertEquals(0, result);
  }
