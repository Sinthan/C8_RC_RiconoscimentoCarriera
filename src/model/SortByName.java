...
/**
 * Comparator for the University Class:
 * It compares the attributes "name" of the class ordering the strings
 * by the cities. (It works only if the cities are written all in capital
 * letters - example: MILANO)
 */
