...
/*
 * RequestRC Class that uses the RequestRC informations Different from Request (Request for English
 * Validation, Request RC for Riconoscimento Carriera)
 */
public class RequestRC {
   ...
   */
  public RequestRC(Date submissionDate, String universityID, String studentID,
  ...
  public String toString() {
    return "RequestRC [requestRCID=" + requestRCID + ", submissionDate=" + submissionDate
        + ", state=" + state + ", universityID=" + universityID + ", reportID=" + reportID
        + ", studentID=" + studentID + ", examsList=" + examsList + "]";
  }
