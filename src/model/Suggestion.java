...
public class Suggestion {
   ...
   */
  public Suggestion(String universityName, String examName, int externalStudentCFU,
      int validatedCFU, String validationMode, Date validationDate) {
  ...
  public String toString() {
    return "Suggestion [univeristyName=" + universityName + ", examName=" + examName
        + ", ExternalStudentCFU=" + externalStudentCFU + ", validationMode=" + validationMode
