...
public class PDFCreator {
  ...
  /*
   * Creazione report con input presi dagli Input del PCD.
   */
  public void createReportPdf(ArrayList<ValidatedExam> esamiValidati, ArrayList<Integer> CfuInterni,
      String nomeStudente, ArrayList<Integer> cfuEsterni, String note) {
  ...
  /*
   * Inserimento pie pagine nel pdf generato.
   */
  ...
  /*
   * Inserimento intestazione nel pdf generato.
   */
  ...
  /*
   * Inserimento tabella degli esami convalidati nel documento pdf.
   */
  public void inserisciTabellaEsamiValidati(ArrayList<ValidatedExam> esamiValidati,
      ArrayList<Integer> CfuInterni, ArrayList<Integer> cfuEsterni, String note) {
    ...
    table.addHeaderCell("Modalit� di convalida"); // Prendere la modalita dall'arrayList
    ...
    for (int i = 0; i < nCelle; i++) {
      ...
      table.addCell(CfuInterni.get(i) + " / " + cfuEsterni.get(i)); // Prendere i cfuValidati e
      // quelli non validati
      table.addCell(esamiValidati.get(i).getValidationProcedure()); // Prendere la modalita
      // dall'arrayList
    }
    document.add(table);
    document.add(new Paragraph(spaces));
