...
public class LoginManagement extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      /*
       * il seguente controllo discrimina in base al ritorno dei singoli metodi delle classi DAO se
       * l'oggetto � diverso da null si procede al reindirizzamento
       */

      if (student != null) { // Profilo Student
        /*
         * il seguente if controlla il tipo di studente tramite l'estenzione della mail cos� da
         * discriminare tra studenti interni ed esterni e reindirizzare alla pagina dedicata
         */
        if ((student.getEmail().substring(student.getEmail().indexOf("@")))
            .equalsIgnoreCase("@studenti.unisa.it")) {
